...
@section('content')  
    <div class="container">  
        <h2 class="font-bold text-xl mb-4">Daftar Tag</h2>  
            ...
            <tbody>  
                @foreach($tags as $tag)  
                    <tr class="border-b">  
                        ...
                        <td class="py-2 px-4 text-right">  
                            <a href="{{ route('tags.edit', $tag) }}" class="text-blue-500 hover:text-blue-700 transition" title="Edit">  
                                <!-- Ikon Edit -->  
                ...
                <tr>  
                    <td class="py-2 px-4 text-left" colspan="2">  
                        <a href="{{ route('tags.create') }}" class="text-green-500 text-xl hover:text-green-700 transition" title="Buat Tag Baru">  
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">  
